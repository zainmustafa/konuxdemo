...
const definePlugin = webpackConfig.plugins.find(
    d => d.constructor.name === "DefinePlugin"
);
if (definePlugin) {
    GITHASH = definePlugin.definitions.GITHASH
        ? definePlugin.definitions.GITHASH.replace(/"/g, "")
        : "";
}
...
module.exports = merge.smart(webpackConfig, {
    ...
    plugins: [
        ...
        new HtmlPlugin({
            ...
            baseHref:
                APP_ENV === "pages" ? "/react-redux-saga-boilerplate/" : ""
        }),
        ...
        new OfflinePlugin({
            ...
            caches: {
                ...
                additional: ["fonts/*.woff", "fonts/*.ttf", "fonts/*.svg"],
                optional: [":rest:"]
            },
            cacheMaps: [
                {
